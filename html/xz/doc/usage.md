...
table of contents](xz/doc/TOC.md)
...
get you started. [About the JavaScript](xz/doc/js.md).
...
[Read more about the `.editorconfig` file](xz/doc/misc.md#editorconfig).
...
refer to the [according documentation](xz/doc/extend.md#apple-touch-icons).
